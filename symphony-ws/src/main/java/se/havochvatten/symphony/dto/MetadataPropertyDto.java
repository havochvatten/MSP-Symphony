...
public class MetadataPropertyDto {
    ...
    String marinePlaneArea;
    String symphonyDataType;
    ...
    public String getAccessUserRestrictions() {
        return accessUserRestrictions;
    }

    public void setAccessUserRestrictions(String accessUserRestrictions) {
        this.accessUserRestrictions = accessUserRestrictions;
    }
