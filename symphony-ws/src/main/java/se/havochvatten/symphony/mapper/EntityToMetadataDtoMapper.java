...
public class EntityToMetadataDtoMapper {
    ...
    private static MetadataPropertyDto mapEntityToPropertyDto(Metadata metadata) {
        ...
        dto.setLinage(metadata.getLineage());
        dto.setMaintanceInformation(metadata.getMaintenanceInformation());
        dto.setMapAknowledgement(metadata.getMapAcknowledgement());
        ...
        dto.setRecomendations(metadata.getRecommendations());
        dto.setStatus(metadata.getStatus());
        dto.setTopicCathegory(metadata.getTopicCategory());
        ...
        dto.setSpacialPresentation(metadata.getSpatialRepresentation());
        dto.setRasterSpacialReferenceSystem(metadata.getRasterSpatialReferencesystem());
