...
# Allow public (unauthenticated) read-only access to the public map viewer ("tittskåp").
# Opt-in feature: must be disabled by default and enabled per deployment.
symphony.public_access=false
