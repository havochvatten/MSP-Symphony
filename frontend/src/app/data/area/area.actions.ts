...
export const createUserDefinedArea = createAction(
  ...
  props<{ name: string, description: string, polygon: Polygon, categoryId?: number }>()
);
...
export const updateUserDefinedArea = createAction(
  ...
  props<{ id: number, name: string, description: string, polygon: Polygon, categoryId?: number }>()
);
